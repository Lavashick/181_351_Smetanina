...
public:
    ...
    void setupUi(QDialog *DialogEditUsers)
    {
        ...
        DialogEditUsers->resize(400, 338);
        ...
        pushButton_7->setGeometry(QRect(160, 300, 75, 23));
        pushButton_7->setAutoDefault(false);
        layoutWidget = new QWidget(DialogEditUsers);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(20, 240, 361, 25));
        ...
        layoutWidget1->setGeometry(QRect(60, 200, 286, 25));
    ...
    void retranslateUi(QDialog *DialogEditUsers)
    {
        ...
        pushButton_3->setText(QApplication::translate("DialogEditUsers", "Delete users", nullptr));
